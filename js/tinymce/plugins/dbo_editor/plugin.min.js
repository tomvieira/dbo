...
tinymce.PluginManager.add( 'dbo_editor', function( editor ) {
	...
	//pega o valor da textarea antes de submeter
	...
	editor.on( 'BeforeSetContent', function( e ) {
		...
		if ( e.content ) {
			...
			//isso é gambiarra.
			//if(!window.dboEditor.first_set){
				//window.dboEditor.first_set = true;								
			//}
			//else {
				e.content = window.dboEditor.dboAutop(e.content);
			//}
			//console.log(window.dboEditor);
		}
	});
	...
	editor.on( 'PostProcess', function( e ) {
		if ( e.get ) {
			...
			//se o editor estiver oculto, retorna somente o valor da textarea como o que interessa
			if(editor.isHidden()){
				e.content = editor.getElement().value;
				//console.log(e.content);
			}
			else {
				e.content = window.dboEditor.dboUnautop(e.content);
